...
{
    public class SlaveTestDBContext: DbContext
    {
        private DbContextOptions<SlaveTestDBContext> _options;
        public SlaveTestDBContext(DbContextOptions<SlaveTestDBContext> options) : base(options)
        {
            _options = options;
        }

        public SlaveTestDBContext() { }
